...
export const RegisterPreferencesStep = ({ form, errors, updateField }: RegisterFieldProps) => {
  ...
  const selectedValue =
    form.city !== "" ? form.city : savedLocation ? String(savedLocation.city.id) : "";
      ...
      <FormField id="city" label="Ciudad principal" error={errors.city} required>
        <Input
          ...
          options={[
            ...
            { value: "111", label: "Bogotá" },
            { value: "121", label: "Medellín" },
            { value: "131", label: "Cali" },
            { value: "141", label: "Barranquilla" },
          ]}
          error={errors.city}
          required
          name="city"
