...
export function Hero() {
  ...
  if (isPending) {
    return (
      <div
        ...
        role="status"
        className="w-full px-4 md:px-0 h-[520px] md:h-[430px] lg:h-[520px] min-h-[600px] md:min-h-0 lg:min-h-0 mt-5 bg-surface-variant animate-[shimmer_1.5s_linear_infinite] bg-[linear-gradient(90deg,var(--color-surface-variant)_25%,var(--color-surface)_50%,var(--color-surface-variant)_75%)] bg-[length:200%_100%]"
      />
    );
  }
  ...
  if (!movies || movies.length === 0) {
    return (
      <div className="flex items-center justify-center w-full px-4 md:px-0 h-[520px] md:h-[430px] lg:h-[520px] min-h-[600px] md:min-h-0 lg:min-h-0 mt-5 bg-surface-variant p-6 text-center">
  ...
  return (
    <section
      ...
      className="relative w-full overflow-hidden bg-background mt-5 px-4 md:px-0"
    >
      {/* Visual viewport */}
      <div
        id="hero-carousel"
