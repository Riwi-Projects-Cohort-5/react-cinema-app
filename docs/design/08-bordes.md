...
- Indicación de estado (focus, error, selección) mediante cambio de color de borde, siempre combinado con otro indicador — nunca el color del borde como único indicador de estado (ver [14 — Accesibilidad](./14-accesibilidad.md)).
