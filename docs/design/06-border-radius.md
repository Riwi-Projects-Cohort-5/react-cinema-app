...
| **LG**   | 16px  | Tarjetas de contenido (películas, funciones, promociones)           |
...
A mayor tamaño del componente, mayor puede ser su radio, siempre manteniendo proporción visual. Nunca mezclar radios de escalas no contiguas dentro de un mismo grupo de componentes (ej. no combinar `XS` y `XL` en la misma tarjeta).
