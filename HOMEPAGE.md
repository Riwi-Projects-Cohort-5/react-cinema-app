...
- [x] Homepage con header de video de fondo.
- [x] Cartelera con tarjetas de películas.
- [x] Datos estáticos de ejemplo.
- [ ] Navegación de los botones Login y Register.
- [ ] Rutas de autenticación (registro e inicio de sesión).


La Homepage es una base sólida: el siguiente paso natural es enlazar los botones del header con las rutas de autenticación y, posteriormente, sustituir el arreglo `movies` por datos provenientes de una API.
