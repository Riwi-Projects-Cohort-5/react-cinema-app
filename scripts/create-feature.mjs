...
try {
  if (fs.existsSync(featureDir)) {
    console.error(`\x1b[31mError:\x1b[0m El feature "${formattedName}" ya existe en src/features/.`);
    process.exit(1);
  }
  ...
  console.log(`\x1b[32m¡Éxito!\x1b[0m Feature "${formattedName}" creado correctamente en \x1b[2msrc/features/${formattedName}\x1b[0m.`);
} catch (error) {
